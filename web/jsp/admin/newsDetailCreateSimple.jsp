...
<body>
	<%--enctype="multipart/form-data"	标注表单为多类型提交--%>
<form name ="dataFrm" id="dataFrm" action="<%=request.getContextPath()%>/jsp/admin/doAdd.jsp" method="post" enctype="multipart/form-data">
	<table  width="100%" border="0" cellspacing="5" cellpadding="0">
		...
		<tbody>
			...
			<tr>
				...
				<td style="text-align:left;">
				<div id="xToolbar"></div>
				<textarea id="newscontent" class="ckeditor" name="newscontent" rows="8" cols="30"></textarea></td>
			</tr>
			<tr>
